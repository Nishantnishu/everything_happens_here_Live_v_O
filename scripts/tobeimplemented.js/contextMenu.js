...
//This needs to be ported to a ContextMenu.js and imported on runTime Via Github. Ver O.2 will save this file locally using PWA and service worker Concept.
...
function genericOnClick(info, tab) {
  ...
  // //this si a asyncfetchcall, it returns a response OBject;
  
  // async function getUrl(){
   
  //   const response = await fetch(url);
  //   const data = await response.data();
  //   document.getElementsByTagName('url').src = url.createObjectURL(data);
  ...
  //         console.log('Valuefrom storage is ' + result.color);
  //       });
